angular.module('app').config(function(ScreenProvider) {
	ScreenProvider.register('screen-watcher-request', {
			controller: function($scope, $http, $upload, Watcher, BioBrokerEndpoint, $routeParams) {
				var file = null; 
				...
				$scope.upload = function() {
					...
					$upload.upload({
							url: '/simulator/request', //upload.php script, node.js route, or servlet url
							method: 'POST',
							data: $scope.f,
							file: file,
